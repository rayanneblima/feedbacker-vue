<template>
  ...
  <div class="flex flex-col items-center justify-center h-64 bg-brand-gray">
    ...
    <p class="text-lg text-center text-gray-800 font-regular">
      Guia para instalar e gerar suas credenciais
    </p>
  </div>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div
        v-else
        class="flex py-3 pl-3 pr-20 mt-2 w-2/3 rounded items-center justify-between bg-brand-gray"
      >
      ...
      >
        ...
        <pre v-else>&lt;script src="https://rayanneblima-feedbacker-widget.netlify.app?api_key={{store.User.currentUser.apiKey}}"&gt;&lt;/script&gt;</pre>
      </div>
    </div>
  </div>
</template>
